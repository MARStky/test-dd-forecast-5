...
import { Download, Upload, AlertTriangle, RefreshCw, BarChart3, Table, Brain } from "lucide-react"
        ...
        <CardFooter className="flex justify-between">
          <div>
            ...
            <Button
              ...
              disabled={isCreatingJob || dataState === "loading"}
            ...
            {jobName ? (
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Create an AutoML job to train a forecasting model</CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    Click the "Create AutoML Job" button to start training a SageMaker Autopilot model with your data.
                    This will automatically select the best algorithm and hyperparameters for your forecasting task.
                  </p>
                </CardContent>
                <CardFooter>
                  <Button
